/*
 * args/struct_info.c - Common code for struct formatting.
 *
 * Provides a generic mechanism to read a struct from tracee memory and format 
 * its fields based on provided metadata (field_info).
 */
